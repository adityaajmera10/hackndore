...
const TeamTable: React.FC = () => {
  ...
  return (
    <>
      <Navbar/>
    <div className='pt-20'>
    <h1 className={`text-2xl text-center md:text-5xl font-bold py-8 ${turret.className} text-primary-heading`}>
                Shortlisted Teams
            </h1>
      <div className='md:w-10/12  flex items-center gap-5 md:gap-10 mx-auto'>
